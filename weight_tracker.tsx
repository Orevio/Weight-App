...
export default function WeightTracker() {
    ...
    const saveGoal = () => {
        ...
        const isFutureDate = (dateStr) => {
            ...
            return target > today; // strictly future? or >= today? Spec says "Future-only selection". "Past dates are impossible". Usually today is allowed for daily goals, but "days left" implies future. "Date must always be in the future." -> > today.
        };
        ...
        const saveGoal = () => {
            if (editingGoal && editDateValue && editWeightValue) {
                ...
                setGoals(prev => {
                    ...
                    // Note: dateObj from string 'YYYY-MM-DD' is UTC treated, but for formatting we want local display usually.
                    // Let's stick to the split method for consistent "what you see is what you get"
